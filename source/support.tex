...
\begin{codeblock}
#define @\defnlibxname{cpp_lib_addressof_constexpr}@               @\cppdate{2016}{03}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_allocate_at_least}@                 @\cppdate{2021}{06}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_allocator_traits_is_always_equal}@  @\cppdate{2014}{11}@
...
#define @\defnlibxname{cpp_lib_adaptor_iterator_pair_constructor}@ @\cppdate{2021}{06}@ // also in \libheader{stack}, \libheader{queue}
#define @\defnlibxname{cpp_lib_any}@                               @\cppdate{2016}{06}@ // also in \libheader{any}
#define @\defnlibxname{cpp_lib_apply}@                             @\cppdate{2016}{03}@ // also in \libheader{tuple}
#define @\defnlibxname{cpp_lib_array_constexpr}@                   @\cppdate{2018}{11}@ // also in \libheader{iterator}, \libheader{array}
#define @\defnlibxname{cpp_lib_as_const}@                          @\cppdate{2015}{10}@ // also in \libheader{utility}
#define @\defnlibxname{cpp_lib_associative_heterogeneous_erasure}@ @\cppdate{2021}{10}@
  // also in \libheader{map}, \libheader{set}, \libheader{unordered_map}, \libheader{unordered_set}
#define @\defnlibxname{cpp_lib_assume_aligned}@                    @\cppdate{2018}{11}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_atomic_flag_test}@                  @\cppdate{2019}{07}@ // also in \libheader{atomic}
#define @\defnlibxname{cpp_lib_atomic_float}@                      @\cppdate{2017}{11}@ // also in \libheader{atomic}
#define @\defnlibxname{cpp_lib_atomic_is_always_lock_free}@        @\cppdate{2016}{03}@ // also in \libheader{atomic}
#define @\defnlibxname{cpp_lib_atomic_lock_free_type_aliases}@     @\cppdate{2019}{07}@ // also in \libheader{atomic}
#define @\defnlibxname{cpp_lib_atomic_ref}@                        @\cppdate{2018}{06}@ // also in \libheader{atomic}
#define @\defnlibxname{cpp_lib_atomic_shared_ptr}@                 @\cppdate{2017}{11}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_atomic_value_initialization}@       @\cppdate{2019}{11}@ // also in \libheader{atomic}, \libheader{memory}
#define @\defnlibxname{cpp_lib_atomic_wait}@                       @\cppdate{2019}{07}@ // also in \libheader{atomic}
#define @\defnlibxname{cpp_lib_barrier}@                           @\cppdate{2019}{07}@ // also in \libheader{barrier}
#define @\defnlibxname{cpp_lib_bind_front}@                        @\cppdate{2019}{07}@ // also in \libheader{functional}
#define @\defnlibxname{cpp_lib_bit_cast}@                          @\cppdate{2018}{06}@ // also in \libheader{bit}
#define @\defnlibxname{cpp_lib_bitops}@                            @\cppdate{2019}{07}@ // also in \libheader{bit}
#define @\defnlibxname{cpp_lib_bool_constant}@                     @\cppdate{2015}{05}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_bounded_array_traits}@              @\cppdate{2019}{02}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_boyer_moore_searcher}@              @\cppdate{2016}{03}@ // also in \libheader{functional}
#define @\defnlibxname{cpp_lib_byte}@                              @\cppdate{2016}{03}@ // also in \libheader{cstddef}
#define @\defnlibxname{cpp_lib_byteswap}@                          @\cppdate{2021}{10}@ // also in \libheader{bit}
#define @\defnlibxname{cpp_lib_char8_t}@                           @\cppdate{2019}{07}@
...
#define @\defnlibxname{cpp_lib_chrono}@                            @\cppdate{2019}{07}@ // also in \libheader{chrono}
#define @\defnlibxname{cpp_lib_chrono_udls}@                       @\cppdate{2013}{04}@ // also in \libheader{chrono}
#define @\defnlibxname{cpp_lib_clamp}@                             @\cppdate{2016}{03}@ // also in \libheader{algorithm}
#define @\defnlibxname{cpp_lib_complex_udls}@                      @\cppdate{2013}{09}@ // also in \libheader{complex}
#define @\defnlibxname{cpp_lib_concepts}@                          @\cppdate{2020}{02}@ // also in \libheader{concepts}
#define @\defnlibxname{cpp_lib_constexpr_algorithms}@              @\cppdate{2018}{06}@ // also in \libheader{algorithm}
#define @\defnlibxname{cpp_lib_constexpr_complex}@                 @\cppdate{2017}{11}@ // also in \libheader{complex}
#define @\defnlibxname{cpp_lib_constexpr_dynamic_alloc}@           @\cppdate{2019}{07}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_constexpr_functional}@              @\cppdate{2019}{07}@ // also in \libheader{functional}
#define @\defnlibxname{cpp_lib_constexpr_iterator}@                @\cppdate{2018}{11}@ // also in \libheader{iterator}
#define @\defnlibxname{cpp_lib_constexpr_memory}@                  @\cppdate{2018}{11}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_constexpr_numeric}@                 @\cppdate{2019}{11}@ // also in \libheader{numeric}
#define @\defnlibxname{cpp_lib_constexpr_string}@                  @\cppdate{2019}{07}@ // also in \libheader{string}
#define @\defnlibxname{cpp_lib_constexpr_string_view}@             @\cppdate{2018}{11}@ // also in \libheader{string_view}
#define @\defnlibxname{cpp_lib_constexpr_tuple}@                   @\cppdate{2018}{11}@ // also in \libheader{tuple}
#define @\defnlibxname{cpp_lib_constexpr_typeinfo}@                @\cppdate{2021}{06}@ // also in \libheader{typeinfo}
#define @\defnlibxname{cpp_lib_constexpr_utility}@                 @\cppdate{2018}{11}@ // also in \libheader{utility}
#define @\defnlibxname{cpp_lib_constexpr_vector}@                  @\cppdate{2019}{07}@ // also in \libheader{vector}
#define @\defnlibxname{cpp_lib_coroutine}@                         @\cppdate{2019}{02}@ // also in \libheader{coroutine}
#define @\defnlibxname{cpp_lib_destroying_delete}@                 @\cppdate{2018}{06}@ // also in \libheader{new}
#define @\defnlibxname{cpp_lib_enable_shared_from_this}@           @\cppdate{2016}{03}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_endian}@                            @\cppdate{2019}{07}@ // also in \libheader{bit}
#define @\defnlibxname{cpp_lib_erase_if}@                          @\cppdate{2020}{02}@
...
#define @\defnlibxname{cpp_lib_exchange_function}@                 @\cppdate{2013}{04}@ // also in \libheader{utility}
#define @\defnlibxname{cpp_lib_execution}@                         @\cppdate{2019}{02}@ // also in \libheader{execution}
#define @\defnlibxname{cpp_lib_filesystem}@                        @\cppdate{2017}{03}@ // also in \libheader{filesystem}
#define @\defnlibxname{cpp_lib_format}@                            @\cppdate{2021}{10}@ // also in \libheader{format}
#define @\defnlibxname{cpp_lib_gcd_lcm}@                           @\cppdate{2016}{06}@ // also in \libheader{numeric}
#define @\defnlibxname{cpp_lib_generic_associative_lookup}@        @\cppdate{2013}{04}@ // also in \libheader{map}, \libheader{set}
#define @\defnlibxname{cpp_lib_generic_unordered_lookup}@          @\cppdate{2018}{11}@
  // also in \libheader{unordered_map}, \libheader{unordered_set}
#define @\defnlibxname{cpp_lib_hardware_interference_size}@        @\cppdate{2017}{03}@ // also in \libheader{new}
#define @\defnlibxname{cpp_lib_has_unique_object_representations}@ @\cppdate{2016}{06}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_hypot}@                             @\cppdate{2016}{03}@ // also in \libheader{cmath}
#define @\defnlibxname{cpp_lib_incomplete_container_elements}@     @\cppdate{2015}{05}@
  // also in \libheader{forward_list}, \libheader{list}, \libheader{vector}
#define @\defnlibxname{cpp_lib_int_pow2}@                          @\cppdate{2020}{02}@ // also in \libheader{bit}
#define @\defnlibxname{cpp_lib_integer_comparison_functions}@      @\cppdate{2020}{02}@ // also in \libheader{utility}
#define @\defnlibxname{cpp_lib_integer_sequence}@                  @\cppdate{2013}{04}@ // also in \libheader{utility}
#define @\defnlibxname{cpp_lib_integral_constant_callable}@        @\cppdate{2013}{04}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_interpolate}@                       @\cppdate{2019}{02}@ // also in \libheader{cmath}, \libheader{numeric}
#define @\defnlibxname{cpp_lib_invoke}@                            @\cppdate{2014}{11}@ // also in \libheader{functional}
#define @\defnlibxname{cpp_lib_invoke_r}@                          @\cppdate{2021}{06}@ // also in \libheader{functional}
#define @\defnlibxname{cpp_lib_is_aggregate}@                      @\cppdate{2017}{03}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_is_constant_evaluated}@             @\cppdate{2018}{11}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_is_final}@                          @\cppdate{2014}{02}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_is_invocable}@                      @\cppdate{2017}{03}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_is_layout_compatible}@              @\cppdate{2019}{07}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_is_nothrow_convertible}@            @\cppdate{2018}{06}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_is_null_pointer}@                   @\cppdate{2013}{09}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_is_pointer_interconvertible}@       @\cppdate{2019}{07}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_is_scoped_enum}@                    @\cppdate{2020}{11}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_is_swappable}@                      @\cppdate{2016}{03}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_jthread}@                           @\cppdate{2019}{11}@ // also in \libheader{stop_token}, \libheader{thread}
#define @\defnlibxname{cpp_lib_latch}@                             @\cppdate{2019}{07}@ // also in \libheader{latch}
#define @\defnlibxname{cpp_lib_launder}@                           @\cppdate{2016}{06}@ // also in \libheader{new}
#define @\defnlibxname{cpp_lib_list_remove_return_type}@           @\cppdate{2018}{06}@ // also in \libheader{forward_list}, \libheader{list}
#define @\defnlibxname{cpp_lib_logical_traits}@                    @\cppdate{2015}{10}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_make_from_tuple}@                   @\cppdate{2016}{06}@ // also in \libheader{tuple}
#define @\defnlibxname{cpp_lib_make_reverse_iterator}@             @\cppdate{2014}{02}@ // also in \libheader{iterator}
#define @\defnlibxname{cpp_lib_make_unique}@                       @\cppdate{2013}{04}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_map_try_emplace}@                   @\cppdate{2014}{11}@ // also in \libheader{map}
#define @\defnlibxname{cpp_lib_math_constants}@                    @\cppdate{2019}{07}@ // also in \libheader{numbers}
#define @\defnlibxname{cpp_lib_math_special_functions}@            @\cppdate{2016}{03}@ // also in \libheader{cmath}
#define @\defnlibxname{cpp_lib_memory_resource}@                   @\cppdate{2016}{03}@ // also in \libheader{memory_resource}
#define @\defnlibxname{cpp_lib_monadic_optional}@                  @\cppdate{2021}{10}@ // also in \libheader{optional}
#define @\defnlibxname{cpp_lib_move_only_function}@                @\cppdate{2021}{10}@ // also in \libheader{functional}
#define @\defnlibxname{cpp_lib_node_extract}@                      @\cppdate{2016}{06}@
  // also in \libheader{map}, \libheader{set}, \libheader{unordered_map}, \libheader{unordered_set}
#define @\defnlibxname{cpp_lib_nonmember_container_access}@        @\cppdate{2014}{11}@
...
#define @\defnlibxname{cpp_lib_not_fn}@                            @\cppdate{2016}{03}@ // also in \libheader{functional}
#define @\defnlibxname{cpp_lib_null_iterators}@                    @\cppdate{2013}{04}@ // also in \libheader{iterator}
#define @\defnlibxname{cpp_lib_optional}@                          @\cppdate{2021}{06}@ // also in \libheader{optional}
#define @\defnlibxname{cpp_lib_out_ptr}@                           @\cppdate{2021}{06}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_parallel_algorithm}@                @\cppdate{2016}{03}@ // also in \libheader{algorithm}, \libheader{numeric}
#define @\defnlibxname{cpp_lib_polymorphic_allocator}@             @\cppdate{2019}{02}@ // also in \libheader{memory_resource}
#define @\defnlibxname{cpp_lib_quoted_string_io}@                  @\cppdate{2013}{04}@ // also in \libheader{iomanip}
#define @\defnlibxname{cpp_lib_ranges}@                            @\cppdate{2021}{10}@
  // also in \libheader{algorithm}, \libheader{functional}, \libheader{iterator}, \libheader{memory}, \libheader{ranges}
#define @\defnlibxname{cpp_lib_ranges_starts_ends_with}@           @\cppdate{2021}{06}@ // also in \libheader{algorithm}
#define @\defnlibxname{cpp_lib_ranges_zip}@                        @\cppdate{2021}{10}@ // also in \libheader{ranges}, \libheader{tuple}, \libheader{utility}
#define @\defnlibxname{cpp_lib_raw_memory_algorithms}@             @\cppdate{2016}{06}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_remove_cvref}@                      @\cppdate{2017}{11}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_result_of_sfinae}@                  @\cppdate{2012}{10}@ // also in \libheader{functional}, \libheader{type_traits}
#define @\defnlibxname{cpp_lib_robust_nonmodifying_seq_ops}@       @\cppdate{2013}{04}@ // also in \libheader{algorithm}
#define @\defnlibxname{cpp_lib_sample}@                            @\cppdate{2016}{03}@ // also in \libheader{algorithm}
#define @\defnlibxname{cpp_lib_scoped_lock}@                       @\cppdate{2017}{03}@ // also in \libheader{mutex}
#define @\defnlibxname{cpp_lib_semaphore}@                         @\cppdate{2019}{07}@ // also in \libheader{semaphore}
#define @\defnlibxname{cpp_lib_shared_mutex}@                      @\cppdate{2015}{05}@ // also in \libheader{shared_mutex}
#define @\defnlibxname{cpp_lib_shared_ptr_arrays}@                 @\cppdate{2017}{07}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_shared_ptr_weak_type}@              @\cppdate{2016}{06}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_shared_timed_mutex}@                @\cppdate{2014}{02}@ // also in \libheader{shared_mutex}
#define @\defnlibxname{cpp_lib_shift}@                             @\cppdate{2018}{06}@ // also in \libheader{algorithm}
#define @\defnlibxname{cpp_lib_smart_ptr_for_overwrite}@           @\cppdate{2020}{02}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_source_location}@                   @\cppdate{2019}{07}@ // also in \libheader{source_location}
#define @\defnlibxname{cpp_lib_span}@                              @\cppdate{2020}{02}@ // also in \libheader{span}
#define @\defnlibxname{cpp_lib_spanstream}@                        @\cppdate{2021}{06}@ // also in \libheader{spanstream}
#define @\defnlibxname{cpp_lib_ssize}@                             @\cppdate{2019}{02}@ // also in \libheader{iterator}
#define @\defnlibxname{cpp_lib_stacktrace}@                        @\cppdate{2020}{11}@ // also in \libheader{stacktrace}
#define @\defnlibxname{cpp_lib_starts_ends_with}@                  @\cppdate{2017}{11}@ // also in \libheader{string}, \libheader{string_view}
#define @\defnlibxname{cpp_lib_stdatomic_h}@                       @\cppdate{2020}{11}@ // also in \libheader{stdatomic.h}
#define @\defnlibxname{cpp_lib_string_contains}@                   @\cppdate{2020}{11}@ // also in \libheader{string}, \libheader{string_view}
#define @\defnlibxname{cpp_lib_string_resize_and_overwrite}@       @\cppdate{2021}{10}@ // also in \libheader{string}
#define @\defnlibxname{cpp_lib_string_udls}@                       @\cppdate{2013}{04}@ // also in \libheader{string}
#define @\defnlibxname{cpp_lib_string_view}@                       @\cppdate{2018}{03}@ // also in \libheader{string}, \libheader{string_view}
#define @\defnlibxname{cpp_lib_syncbuf}@                           @\cppdate{2018}{03}@ // also in \libheader{syncstream}
#define @\defnlibxname{cpp_lib_three_way_comparison}@              @\cppdate{2019}{07}@ // also in \libheader{compare}
#define @\defnlibxname{cpp_lib_to_address}@                        @\cppdate{2017}{11}@ // also in \libheader{memory}
#define @\defnlibxname{cpp_lib_to_array}@                          @\cppdate{2019}{07}@ // also in \libheader{array}
#define @\defnlibxname{cpp_lib_to_chars}@                          @\cppdate{2016}{11}@ // also in \libheader{charconv}
#define @\defnlibxname{cpp_lib_to_underlying}@                     @\cppdate{2021}{02}@ // also in \libheader{utility}
#define @\defnlibxname{cpp_lib_transformation_trait_aliases}@      @\cppdate{2013}{04}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_transparent_operators}@             @\cppdate{2015}{10}@ // also in \libheader{memory}, \libheader{functional}
#define @\defnlibxname{cpp_lib_tuple_element_t}@                   @\cppdate{2014}{02}@ // also in \libheader{tuple}
#define @\defnlibxname{cpp_lib_tuples_by_type}@                    @\cppdate{2013}{04}@ // also in \libheader{utility}, \libheader{tuple}
#define @\defnlibxname{cpp_lib_type_identity}@                     @\cppdate{2018}{06}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_type_trait_variable_templates}@     @\cppdate{2015}{10}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_uncaught_exceptions}@               @\cppdate{2014}{11}@ // also in \libheader{exception}
#define @\defnlibxname{cpp_lib_unordered_map_try_emplace}@         @\cppdate{2014}{11}@ // also in \libheader{unordered_map}
#define @\defnlibxname{cpp_lib_unwrap_ref}@                        @\cppdate{2018}{11}@ // also in \libheader{type_traits}
#define @\defnlibxname{cpp_lib_variant}@                           @\cppdate{2021}{06}@ // also in \libheader{variant}
#define @\defnlibxname{cpp_lib_void_t}@                            @\cppdate{2014}{11}@ // also in \libheader{type_traits}
\end{codeblock}
