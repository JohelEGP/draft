...
\tcode{carries_dependency}    & \cppdate{2008}{09} \\
\tcode{deprecated}            & \cppdate{2013}{09} \\
\tcode{fallthrough}           & \cppdate{2016}{03} \\
\tcode{likely}                & \cppdate{2018}{03} \\
\tcode{maybe_unused}          & \cppdate{2016}{03} \\
\tcode{no_unique_address}     & \cppdate{2018}{03} \\
\tcode{nodiscard}             & \cppdate{2019}{07} \\
\tcode{noreturn}              & \cppdate{2008}{09} \\
\tcode{unlikely}              & \cppdate{2018}{03} \\
\end{floattable}
...
\endhead
\defnxname{cpp_aggregate_bases}                   & \cppdate{2016}{03} \\ \rowsep
\defnxname{cpp_aggregate_nsdmi}                   & \cppdate{2013}{04} \\ \rowsep
\defnxname{cpp_aggregate_paren_init}              & \cppdate{2019}{02} \\ \rowsep
\defnxname{cpp_alias_templates}                   & \cppdate{2007}{04} \\ \rowsep
\defnxname{cpp_aligned_new}                       & \cppdate{2016}{06} \\ \rowsep
\defnxname{cpp_attributes}                        & \cppdate{2008}{09} \\ \rowsep
\defnxname{cpp_binary_literals}                   & \cppdate{2013}{04} \\ \rowsep
\defnxname{cpp_capture_star_this}                 & \cppdate{2016}{03} \\ \rowsep
\defnxname{cpp_char8_t}                           & \cppdate{2018}{11} \\ \rowsep
\defnxname{cpp_concepts}                          & \cppdate{2019}{07} \\ \rowsep
\defnxname{cpp_conditional_explicit}              & \cppdate{2018}{06} \\ \rowsep
\defnxname{cpp_constexpr}                         & \cppdate{2021}{10} \\ \rowsep
\defnxname{cpp_constexpr_dynamic_alloc}           & \cppdate{2019}{07} \\ \rowsep
\defnxname{cpp_constexpr_in_decltype}             & \cppdate{2017}{11} \\ \rowsep
\defnxname{cpp_consteval}                         & \cppdate{2018}{11} \\ \rowsep
\defnxname{cpp_constinit}                         & \cppdate{2019}{07} \\ \rowsep
\defnxname{cpp_decltype}                          & \cppdate{2007}{07} \\ \rowsep
\defnxname{cpp_decltype_auto}                     & \cppdate{2013}{04} \\ \rowsep
\defnxname{cpp_deduction_guides}                  & \cppdate{2019}{07} \\ \rowsep
\defnxname{cpp_delegating_constructors}           & \cppdate{2006}{04} \\ \rowsep
\defnxname{cpp_designated_initializers}           & \cppdate{2017}{07} \\ \rowsep
\defnxname{cpp_enumerator_attributes}             & \cppdate{2014}{11} \\ \rowsep
\defnxname{cpp_explicit_this_parameter}           & \cppdate{2021}{10} \\ \rowsep
\defnxname{cpp_fold_expressions}                  & \cppdate{2016}{03} \\ \rowsep
\defnxname{cpp_generic_lambdas}                   & \cppdate{2017}{07} \\ \rowsep
\defnxname{cpp_guaranteed_copy_elision}           & \cppdate{2016}{06} \\ \rowsep
\defnxname{cpp_hex_float}                         & \cppdate{2016}{03} \\ \rowsep
\defnxname{cpp_if_consteval}                      & \cppdate{2021}{06} \\ \rowsep
\defnxname{cpp_if_constexpr}                      & \cppdate{2016}{06} \\ \rowsep
\defnxname{cpp_impl_coroutine}                    & \cppdate{2019}{02} \\ \rowsep
\defnxname{cpp_impl_destroying_delete}            & \cppdate{2018}{06} \\ \rowsep
\defnxname{cpp_impl_three_way_comparison}         & \cppdate{2019}{07} \\ \rowsep
\defnxname{cpp_inheriting_constructors}           & \cppdate{2015}{11} \\ \rowsep
\defnxname{cpp_init_captures}                     & \cppdate{2018}{03} \\ \rowsep
\defnxname{cpp_initializer_lists}                 & \cppdate{2008}{06} \\ \rowsep
\defnxname{cpp_inline_variables}                  & \cppdate{2016}{06} \\ \rowsep
\defnxname{cpp_lambdas}                           & \cppdate{2009}{07} \\ \rowsep
\defnxname{cpp_modules}                           & \cppdate{2019}{07} \\ \rowsep
\defnxname{cpp_multidimensional_subscript}        & \cppdate{2021}{10} \\ \rowsep
\defnxname{cpp_namespace_attributes}              & \cppdate{2014}{11} \\ \rowsep
\defnxname{cpp_noexcept_function_type}            & \cppdate{2015}{10} \\ \rowsep
\defnxname{cpp_nontype_template_args}             & \cppdate{2019}{11} \\ \rowsep
\defnxname{cpp_nontype_template_parameter_auto}   & \cppdate{2016}{06} \\ \rowsep
\defnxname{cpp_nsdmi}                             & \cppdate{2008}{09} \\ \rowsep
\defnxname{cpp_range_based_for}                   & \cppdate{2016}{03} \\ \rowsep
\defnxname{cpp_raw_strings}                       & \cppdate{2007}{10} \\ \rowsep
\defnxname{cpp_ref_qualifiers}                    & \cppdate{2007}{10} \\ \rowsep
\defnxname{cpp_return_type_deduction}             & \cppdate{2013}{04} \\ \rowsep
\defnxname{cpp_rvalue_references}                 & \cppdate{2006}{10} \\ \rowsep
\defnxname{cpp_size_t_suffix}                     & \cppdate{2020}{11} \\ \rowsep
\defnxname{cpp_sized_deallocation}                & \cppdate{2013}{09} \\ \rowsep
\defnxname{cpp_static_assert}                     & \cppdate{2014}{11} \\ \rowsep
\defnxname{cpp_structured_bindings}               & \cppdate{2016}{06} \\ \rowsep
\defnxname{cpp_template_template_args}            & \cppdate{2016}{11} \\ \rowsep
\defnxname{cpp_threadsafe_static_init}            & \cppdate{2008}{06} \\ \rowsep
\defnxname{cpp_unicode_characters}                & \cppdate{2007}{04} \\ \rowsep
\defnxname{cpp_unicode_literals}                  & \cppdate{2007}{10} \\ \rowsep
\defnxname{cpp_user_defined_literals}             & \cppdate{2008}{09} \\ \rowsep
\defnxname{cpp_using_enum}                        & \cppdate{2019}{07} \\ \rowsep
\defnxname{cpp_variable_templates}                & \cppdate{2013}{04} \\ \rowsep
\defnxname{cpp_variadic_templates}                & \cppdate{2007}{04} \\ \rowsep
\defnxname{cpp_variadic_using}                    & \cppdate{2016}{11} \\
\end{LongTable}
...
An integer literal of the form \cppdate{yyyy}{mm} (for example,
\cppdate{1997}{12}).
